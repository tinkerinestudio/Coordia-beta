...
class window(wx.Frame):
    def __init__(self,f,size=(500,500),build_dimensions=[200,200,100,0,0,0],grid=(10,50),extrusion_width=0.5):
...
class gviz(wx.Panel):
    def __init__(self,parent,size=(500,500),build_dimensions=[200,200,100,0,0,0],grid=(10,50),extrusion_width=0.5):
        ...
        self.travelpen=wx.Pen(wx.Colour(255,255,255),penwidth)
    ...
    def repaint(self):
        ...
        dc.SetBackground(wx.Brush((120,120,120))) #justin: bg of grid
        dc.Clear()
        ...
        if not self.showall:
            ...
            dc.SetBrush(wx.Brush((180,180,180)))
            if self.size[0]>400:
                dc.DrawRectangle(self.size[0]-15,0,15,self.size[1]) #justin: green bar
                dc.SetBrush(wx.Brush((175,220,115)))
                if len(self.layers):
                    dc.DrawRectangle(self.size[0]-15,(1.0-(1.0*(self.layerindex+1))/len(self.layers))*self.size[1],13,self.size[1]-1) #justin: blue bar
